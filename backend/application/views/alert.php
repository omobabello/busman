            ...
            <div class="navbar-collapse">
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
					<ul class="nav" id="side-menu">
						<li>
							<a href="<?php echo $linked ? site_url('home/home') : '#' ?>"><i class="fa fa-home nav_icon"></i>Dashboard</a>
						</li>
						<li>
							<a href="#"><i class="fa fa-folder-open nav_icon"></i>Bookings<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level collapse">
								<li>
									<a href="<?php echo $linked ? site_url('home/today_bookings') : '#' ?>">Today</a>
								</li>
                <li>
									<a href="<?php echo $linked ? site_url('home/month_bookings') : '#' ?>">This Month</a>
								</li>
							</ul>
							<!-- //nav-second-level -->
						</li>
						<li>
							<a href="<?php echo $linked ? site_url('home/buses') : '#' ?>"><i class="fa fa-truck nav_icon"></i>Buses</a>
						</li>
            <li>
							<a href="<?php echo $linked ? site_url('home/routes') : '#' ?>"><i class="fa fa-road nav_icon"></i>Routes</a>
						</li>
						<li>
							<a href="#"><i class="fa fa-book nav_icon"></i>Accounts <span class="fa arrow"></span></a>
							<ul class="nav nav-second-level collapse">
								<li>
									<a href="<?php  echo $linked ? site_url('home/account_mon') : '#' ?>">Monthly</a>
								</li>
								<li>
									<a href="<?php  echo  $linked ? site_url('home/account_year') : '#' ?>">Yearly</a>
								</li>
							</ul>
						</li>
						<li>
